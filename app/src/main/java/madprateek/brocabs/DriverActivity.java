...
public class DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmail = (TextInputLayout) findViewById(R.id.driverEmailBtn);
        mPass = (TextInputLayout) findViewById(R.id.driverPassBtn);
        mLogin = (Button) findViewById(R.id.driverLoginBtn);
        mReg = (TextView) findViewById(R.id.driverRegBtn);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            databaseReference = FirebaseDatabase.getInstance().getReference().child("Users").child("Driver").child(uid);
